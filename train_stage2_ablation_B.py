    ...
    def train(self, train_loader, val_loader):
        ...
        for epoch in range(start_epoch, self.config.num_epochs):
            ...
            if val_loss < self.best_val_loss - early_stop_min_delta:
                ...
                is_best = False
                print(f"early sto: {self.patience_counter}/{early_stop_patience}")
...
def main():
    ...
    training_config.save_dir = './checkpoints/stage2_ablation_B'
    ...
    consensus_model = ConsensusModel_ConcatFusion(
