...
from model import ConsensusModel_NoProj   # 导入无投影模型
...
def main():
    ...
    # 设置保存路径为 ablation_E
    training_config.save_dir = './checkpoints/stage2_ablation_E'
    ...
    # 创建无投影模型
    consensus_model = ConsensusModel_NoProj(
